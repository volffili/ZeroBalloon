...
public class Utils {
	...
	public static void callScriptFunc(String from, Object key, Object value) {
		...
		Utils.d(TAG, "SID: "+Integer.toString(script_instanceID));
		//Utils.d(TAG, "KEY: "+key.toString(script_instanceID));
		//Utils.d(TAG, "VAL: "+value.toString(script_instanceID));
		...
		GodotLib.calldeferred(script_instanceID, "_receive_message",new Object[] { TAG, from, key, value });
	}
