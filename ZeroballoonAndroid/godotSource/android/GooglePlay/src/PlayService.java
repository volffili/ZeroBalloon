...
public class PlayService{
	...
	public void loadScoreOfLeaderBoard() {
		...
		mLeaderboardsClient.loadCurrentPlayerLeaderboardScore("CgkIwrfiwb4EEAIQAw", LeaderboardVariant.TIME_SPAN_ALL_TIME, LeaderboardVariant.COLLECTION_PUBLIC)
			...
			public void onSuccess(AnnotatedData<LeaderboardScore> leaderboardScoreAnnotatedData) {
				...
				if (leaderboardScoreAnnotatedData != null) {
					if (leaderboardScoreAnnotatedData.get() != null) {
						...
						Utils.callScriptFunc("GooglePlay", "score", score);
					}
				}
			}
		})
		.addOnFailureListener(new OnFailureListener() {
			...
			public void onFailure(Exception e) {
				Utils.callScriptFunc("GooglePlay", "ERROR", "1");
			}
		});
	}
